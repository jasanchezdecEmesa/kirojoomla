...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="tipovisita-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', Text::_('COM_ERESERVAS_TITLE_TIPOVISITA', true)); ?>
		<div class="row-fluid">
