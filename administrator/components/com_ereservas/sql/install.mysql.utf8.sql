...
CREATE TABLE IF NOT EXISTS `#__ereservas_servicio_semanal` (
`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__ereservas_fechas_apertura` (
`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
`created_by` INT(11)  NOT NULL ,
`modified_by` INT(11)  NOT NULL ,
`dia_apertura` TINYINT NOT NULL ,
`mes_apertura` VARCHAR(255)  NOT NULL ,
`mes_final` VARCHAR(255)  NOT NULL ,
PRIMARY KEY (`id`)
) DEFAULT COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `#__ereservas_cierres` (
`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__ereservas_cancelaciones` (
`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
`email` VARCHAR(255)  NOT NULL ,
`nombre` VARCHAR(255)  NOT NULL ,
`plazas` VARCHAR(255)  NOT NULL ,
`total` VARCHAR(255)  NOT NULL ,
`telefono` VARCHAR(255)  NOT NULL ,
PRIMARY KEY (`id`)
) DEFAULT COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `#__ereservas_lista_espera` (
`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
