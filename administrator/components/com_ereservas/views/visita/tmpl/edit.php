...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="visita-form" class="form-validate form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'visita')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'visita', JText::_('COM_ERESERVAS_TAB_VISITA', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_ERESERVAS_FIELDSET_VISITA'); ?></legend>
