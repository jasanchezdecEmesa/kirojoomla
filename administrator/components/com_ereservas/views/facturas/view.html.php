 ...
 * @since  1.6
 */
class EreservasViewFacturas extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		EreservasHelper::addSubmenu('facturas');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_ERESERVAS_TITLE_FACTURAS'), 'facturas.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('facturas.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_ereservas&view=facturas');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`nombre`' => JText::_('COM_ERESERVAS_FACTURAS_NOMBRE'),
			'a.`nif`' => JText::_('COM_ERESERVAS_FACTURAS_NIF'),
			'a.`cpostal`' => JText::_('COM_ERESERVAS_FACTURAS_CPOSTAL'),
			'a.`municipio`' => JText::_('COM_ERESERVAS_FACTURAS_MUNICIPIO'),
			'a.`precio`' => JText::_('COM_ERESERVAS_FACTURAS_PRECIO'),
		);
	}
