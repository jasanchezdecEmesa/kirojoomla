...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="reserva-form" class="form-validate form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'reserva')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'reserva', JText::_('COM_ERESERVAS_TAB_RESERVA', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_ERESERVAS_FIELDSET_RESERVA'); ?></legend>
