...
JHtmlSidebar::addEntry(
			JText::_('COM_ERESERVAS_TITLE_SERVICIOSEMANALES'),
			'index.php?option=com_ereservas&view=serviciosemanales',
			$vName == 'serviciosemanales'
		);

JHtmlSidebar::addEntry(
			JText::_('COM_ERESERVAS_TITLE_FECHASAPERTURAS'),
			'index.php?option=com_ereservas&view=fechasaperturas',
			$vName == 'fechasaperturas'
		);

JHtmlSidebar::addEntry(
			JText::_('COM_ERESERVAS_TITLE_CIERRES'),
			'index.php?option=com_ereservas&view=cierres',
			$vName == 'cierres'
		);

JHtmlSidebar::addEntry(
			JText::_('COM_ERESERVAS_TITLE_CANCELACIONES'),
			'index.php?option=com_ereservas&view=cancelaciones',
			$vName == 'cancelaciones'
		);

JHtmlSidebar::addEntry(
			JText::_('COM_ERESERVAS_TITLE_LISTAESPERAS'),
			'index.php?option=com_ereservas&view=listaesperas',
			$vName == 'listaesperas'
		);
