...
<div class="sala-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-sala"
			  action="<?php echo JRoute::_('index.php?option=com_ereservas&task=sala.save'); ?>"
	...
	<?php echo $this->form->renderField('observaciones'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_ereservas&task=salaform.cancel'); ?>"
