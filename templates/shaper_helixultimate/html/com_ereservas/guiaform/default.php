...
<div class="guia-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-guia"
			  action="<?php echo JRoute::_('index.php?option=com_ereservas&task=guia.save'); ?>"
	...
	<?php echo $this->form->renderField('nombre'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_ereservas&task=guiaform.cancel'); ?>"
