...
<div class="tipocliente-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		<?php if (!empty($this->item->id)): ?>
			<h1><?php echo JText::sprintf('COM_ERESERVAS_EDIT_ITEM_TITLE', $this->item->id); ?></h1>
		<?php else: ?>
			<h1><?php echo JText::_('COM_ERESERVAS_ADD_ITEM_TITLE'); ?></h1>
		<?php endif; ?>

		<form id="form-tipocliente"
			  action="<?php echo JRoute::_('index.php?option=com_ereservas&task=tipocliente.save'); ?>"
	...
	<?php echo $this->form->renderField('observaciones'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_ereservas&task=tipoclienteform.cancel'); ?>"
