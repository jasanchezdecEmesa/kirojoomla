...
<div class="tipocliente-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-tipocliente"
			  action="<?php echo Route::_('index.php?option=com_ereservas&task=tipocliente.save'); ?>"
	...
	<?php echo $this->form->renderField('observaciones'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo Route::_('index.php?option=com_ereservas&task=tipoclienteform.cancel'); ?>"
