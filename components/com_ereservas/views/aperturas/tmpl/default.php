...
$document->addScript(Uri::root() . 'media/com_ereservas/js/aperturas.js?v=2');

?>
<div>
	<h1>Aperturas Periódicas</h1>
	...
	<table class="table table-stripped table-hover" id="tabla_aperturas">
        ...
        <td><?php echo substr($dato['hora_inicio'],0,5);?></td>
        <td><?php echo substr($dato['hora_final'],0,5);?></td>
        <td><?php
            $dias = str_replace('1',' L',$dato['dias_semana']);
            $dias = str_replace('2',' Ma',$dias);
            $dias = str_replace('3',' Mi',$dias);
            $dias = str_replace('4',' J',$dias);
            $dias = str_replace('5',' V',$dias);
            $dias = str_replace('6',' S',$dias);
            $dias = str_replace('7',' D',$dias);
            echo $dias; ?></td>
        <td><?php echo $dato['nombre_idioma']; ?></td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="hora_inicio" name="hora_inicio" type="time" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="hora_final">Hora Fin</label>
                            <input class="form-control" type="time" name="hora_final" id="hora_final">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <input type="checkbox" name="dias_semana" id="dia-1" value="1"> Lunes
                        </div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="dias_semana" id="dia-2" value="2"> Martes
                        </div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="dias_semana" id="dia-3" value="3"> Miércoles
                        </div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="dias_semana" id="dia-4" value="4"> Jueves
                        </div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="dias_semana" id="dia-5" value="5"> Viernes
                        </div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="dias_semana" id="dia-6" value="6"> Sábado
                        </div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="dias_semana" id="dia-7" value="7"> Domingo
                        </div>
                    </div>
...
<div class="modal fade" id="modal-eliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>¿Estas seguro que quieres borrar las visitas <span id="borrar-nombre-visita"></span> del <span id="borrar-dia-inicio"></span> al <span id="borrar-dia-fin"></span> a las  <span id="borrar-hora-inicio"></span>?</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
