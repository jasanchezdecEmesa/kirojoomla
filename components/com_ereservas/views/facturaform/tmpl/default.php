...
<div class="factura-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-factura"
			  action="<?php echo Route::_('index.php?option=com_ereservas&task=factura.save'); ?>"
	...
	<?php foreach((array)$this->item->id_reserva as $value): ?>
		<?php if(!is_array($value)): ?>
			<input type="hidden" class="id_reserva" name="jform[id_reservahidden][<?php echo $value; ?>]" value="<?php echo $value; ?>" />
		<?php endif; ?>
	<?php endforeach; ?>
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo Route::_('index.php?option=com_ereservas&task=facturaform.cancel'); ?>"
