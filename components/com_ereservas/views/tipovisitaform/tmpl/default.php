...
<div class="tipovisita-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-tipovisita"
			  action="<?php echo Route::_('index.php?option=com_ereservas&task=tipovisita.save'); ?>"
	...
	<?php echo $this->form->renderField('descripcion'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo Route::_('index.php?option=com_ereservas&task=tipovisitaform.cancel'); ?>"
