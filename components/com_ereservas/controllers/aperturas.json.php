 ...
 * @since  1.6
 */
class EreservasControllerAperturas extends EreservasController{
    ...
    public function comprobarid(){
        ...
        $datos['hora_inicio'] = $jinput->get("hora_inicio", false,'html');
        $datos['hora_final'] = $jinput->get("hora_final", false,'html');
        $datos['id_tipo_visita'] = $jinput->get("id_tipo_visita", false,'html');
        $datos['idioma'] = $jinput->get("idioma", false,'html');
        $datos['dias_semana'] = $jinput->get("dias_semana", false,'html');
        ...
        EreservasVisitas::generarVisitas($datos);
