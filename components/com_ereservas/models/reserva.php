 ...
 * @since  1.6
 */
class EreservasModelReserva extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	public function getItem($id = null)
	{
		...
		if (!empty($this->_item->asistencia))
		{
			$this->_item->asistencia = JText::_('COM_ERESERVAS_RESERVAS_ASISTENCIA_OPTION_' . $this->_item->asistencia);
		}
