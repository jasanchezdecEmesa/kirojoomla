 ...
 * @since  1.6
 */
class EreservasModelVisitaspublicas extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			$item->comida = JText::_('COM_ERESERVAS_TIPOVISITAS_COMIDA_OPTION_' . strtoupper($item->comida));

			$item->cata = JText::_('COM_ERESERVAS_TIPOVISITAS_CATA_OPTION_' . strtoupper($item->cata));
