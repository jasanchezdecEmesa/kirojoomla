...
class Functions
{
            ...
            <div>
                <div class="w357-product-info-buttons w357" style="text-align: center; margin-top: 20px;">
                    <?php if (!empty($item->live_demo_url)): ?>
                        <a href="<?php echo $item->live_demo_url; ?>" class="btn btn-primary btn-sm mb-2" target="_blank">Live Demo</a>
                    <?php endif; ?>

                    <?php if (!empty($item->more_info_url)): ?>
                        <a href="<?php echo $item->more_info_url; ?>" class="btn btn-success btn-sm mb-2" target="_blank">Product's Page</a>
                    <?php endif; ?>

                    <?php if (!empty($item->documentation_url)): ?>
                        <a href="<?php echo $item->documentation_url; ?>" class="btn btn-warning btn-sm mb-2" target="_blank">Documentation</a>
                    <?php endif; ?>

                    <?php if (!empty($item->changelog_url)): ?>
                        <a href="<?php echo $item->changelog_url; ?>" class="btn btn-info btn-sm mb-2" target="_blank">Changelog</a>
                    <?php endif; ?>

                    <?php if (!empty($item->support_url)): ?>
                        <a href="<?php echo $item->support_url; ?>" class="btn btn-danger btn-sm mb-2" target="_blank">Support</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    public static function showFooter($extension, $extension_real_name)
    {
        ...
        {
            $comParams = ComponentHelper::getParams($extension);
            if ($comParams)
            {
