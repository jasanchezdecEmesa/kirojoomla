...
class JFormFieldTextsforlanguages extends FormField {
	...
	public function loadLangFormFields($language_name = "English", $lang_code = "en_GB", $value = '', $num = 0)
	{
		...
		// header
		$html .= '<div class="w357frm_param_header w357_small_header vj34x com_plugins" style="margin-top: '.($num>0?30:0).'px;"><label id="jform_params___field8-lbl" for="jform_params___field8" class="">'.$lang_img.' '.Text::_('J357_PLG_SYSTEM_COOKIESPOLICYNOTIFICATIONBAR_TEXTS_FOR').' '.$display_language_name.'</label></div>';
