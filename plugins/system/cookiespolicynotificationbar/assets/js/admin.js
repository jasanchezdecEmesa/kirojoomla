...
jQuery(document).ready(function ($) {
    ...
    var deleteAcceptanceLogs = function () {
        $.ajax({
            ...
            complete: function () {
                setTimeout(function () {
                    $('.cpnb-loading-gif').hide();
                    $('.cpnb-acceptance-logs-deleted-msg').css(
                        'display',
                        'block'
                    );
                }, 3000);
    ...
    $(document).on('click', '.cpnb-delete-acceptance-logs-btn', function (e) {
        ...
        var delete_confirmation_msg = $(
            '.cpnb-delete-acceptance-logs-btn'
        ).data('cpnb-delete-confirmation-msg');
    ...
    $(document).on('click', '.cpnb-restore-to-detafaults-btn', function (e) {
        ...
        var restore_to_defaults_confirmation_msg = $(
            '.cpnb-restore-to-detafaults-btn'
        ).data('cpnb-restore-to-defaults-confirmation-msg');
