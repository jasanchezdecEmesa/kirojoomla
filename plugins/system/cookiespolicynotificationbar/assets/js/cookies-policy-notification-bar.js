    ...
    function () {
        ...
        if (
            ...
            if (
                ...
                var linkFun = settings.w357_current_url;
                ...
                switch (btn) {
                    case 'ok':
                        ...
                        if (settings.w357_display_ok_btn == 1) {
                            ...
                            cnbwb +=
                                '				<span id="cpnb-accept-btn" onClick="cpnb_warning_accept_button(\'' +
                                settings.w357_joomla_caching +
                                "', '" +
                    ...
                    case 'decline':
                        ...
                        if (settings.w357_display_decline_btn == 1) {
                            ...
                            cnbwb +=
                                '				<span id="cpnb-decline-btn" onClick="cpnb_warning_decline_button(\'' +
                                settings.w357_joomla_caching +
                                "', '" +
                                decodeURI(enableConfirFun) +
                                "', '" +
                    ...
                    case 'cancel':
                        ...
                        if (settings.w357_display_cancel_btn == 1) {
                            ...
                            cnbwb +=
                                '				<span id="cpnb-cancel-btn" onClick="cpnb_warning_cancel_button(\'' +
                                cookieNameFun +
                                "', '" +
                                expiration +
                                "', '" +
                        ...
                        if (settings.w357_display_more_info_btn == 1) {
                            if (
                                ...
                                if (settings.w357_link_target == '_self') {
                                    ...
                                    cnbwb +=
                                        '				<span id="cpnb-moreinfo-btn" onClick="w357_openPopUpWindowMoreInfo(\'' +
                                        settings.w357_buttonMoreLink +
                                        "','titlos', '" +
                                ...
                                cnbwb +=
                                    '				<span id="cpnb-moreinfo-btn" onClick="cpnb_openModalMoreInfo()" class="cpnb-button cpnb-button-more-default ' +
                                    decodeURI(
                                        settings.w357_moreinfo_button_class_notification_bar
                                    ) +
                    ...
                    case 'settings':
                        ...
                        if (settings.w357_display_settings_btn == 1) {
                            cnbwb +=
                                '				<span id="cpnb-settings-btn" onClick="cpnb_m_openModal()" class="cpnb-button cpnb-button-settings ' +
                                decodeURI(
                    ...
                    switch (btn) {
                        case 'ok':
                            ...
                            if (settings.w357_display_ok_btn == 1) {
                                ...
                                var linkFun = settings.w357_current_url;
                                cnbwb +=
                                    '				<span id="cpnb-accept-btn-m-info" onClick="cpnb_warning_accept_button(\'' +
                                    settings.w357_joomla_caching +
                                    "', '" +
                                    decodeURI(enableConfirFun) +
                                    "', '" +
                        ...
                        case 'decline':
                            ...
                            if (settings.w357_display_decline_btn == 1) {
                                ...
                                var linkFun = settings.w357_current_url;
                                cnbwb +=
                                    '				<span id="cpnb-decline-btn-m-info" onClick="cpnb_warning_decline_button(\'' +
                                    settings.w357_joomla_caching +
                                    "', '" +
                                    decodeURI(enableConfirFun) +
                                    "', '" +
                        ...
                        case 'cancel':
                            ...
                            if (settings.w357_display_cancel_btn == 1) {
                                ...
                                var linkFun = settings.w357_current_url;
                                cnbwb +=
                                    '				<span id="cpnb-cancel-btn-m-info" onClick="cpnb_warning_cancel_button(\'' +
                                    cookieNameFun +
                                    "', '" +
                                    expiration +
                                    "', '" +
                        ...
                        case 'settings':
                            ...
                            if (settings.w357_display_settings_btn == 1) {
                                cnbwb +=
                                    '				<span id="cpnb-settings-btn-m-info" onClick="cpnb_m_openModal()" class="cpnb-button cpnb-button-settings ' +
                                    decodeURI(
                                        settings.w357_settings_button_class_notification_bar
                                    ) +
                                    '">' +
                    ...
                    if (categoriesSettingsCookie[innerCookieCategory] == null) {
                        if (
                            ...
                            HTMLinformationBoxes +=
                                ...
                                categoryID +
                                '" name="modalCheckBox_id_' +
                                categoryID +
                                '" checked/><label for="modalCheckBox_id_' +
                                categoryID +
                                '">' +
    ...
    if (
        ...
        if (cpnb_readCookie('cpnbCookiesDeclined') == null) {
            ...
            var postData = {
                ...
                dt: w357_joomla_caching > 0 ? new Date().getTime() : undefined,
            };
...
function cpnb_warning_decline_button(
    ...
    var postData = {
        cpnb_method: 'cpnbCookiesDeclined',
        cpnb_btn_area: isModalWindow ? 'cookiesManager' : 'notificationBar',
        dt: w357_joomla_caching > 0 ? new Date().getTime() : undefined,
    };
...
function cpnb_warning_delete_button(
    ...
    var postData = {
        cpnb_method: 'cpnbCookiesDeleted',
        dt: w357_joomla_caching > 0 ? new Date().getTime() : undefined,
    };
...
function sendPostRequest(url, params) {
    console.log('sendPostRequest', url, params);
    // Params should be an object containing key-value pairs
    let formData = new URLSearchParams(params).toString();
    ...
    fetch(url, {
        ...
        body: formData, // Sending the URL-encoded string
    })
        .then((response) => {
            if (!response.ok) {
